...
| e2e flake: peer-reaction untoggle    | **Recurred 2026-07-24** (`aria-pressed` stayed `true` after untoggling) once the sign-in flake stopped masking it. Now the top remaining flake — apply the D45 medicine (prop-seeded state or action-return reconciliation). |
